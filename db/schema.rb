...
ActiveRecord::Schema[7.1].define(version: 2024_04_18_070843) do
  ...
  create_table "beta_updates", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
  ...
  create_table "customer_transactions", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "product_id"
    t.string "name"
    t.string "email"
  ...
  create_table "funnel_domains", id: false, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "funnels", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "title"
    t.string "path"
  ...
  create_table "image_lists", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "imgid"
    t.string "url"
    t.datetime "created_at", null: false
  ...
  create_table "products_steps", id: false, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "rebilly_plans", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "rebilly_plan_id"
    t.string "plan_name"
  ...
  create_table "scheduled_worktasks", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "step_types", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "kind"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_beta_updates", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "user_id"
  ...
  create_table "worktask_types", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "kind"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "worktasks", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "from_name"
    t.string "from_email"
