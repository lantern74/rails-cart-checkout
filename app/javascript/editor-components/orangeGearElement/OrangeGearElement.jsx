...
function OrangeGearElement(element) {
  ...
  var parentType = element.getAttribute("data-de-type");
      ...
      if (parentType === "headline-field") {
          ...
          setHeadlinePopup.classList.contains("open") ? closeAllSidebars() : setHeadlinePopup.classList.add("open");
          ...
          setTwoStepOrderPopup.classList.contains("open") ? closeAllSidebars() : setTwoStepOrderPopup.classList.add("open");
...
//? also it tells us if it's existing element or not
  ...
  if (interactionType === "drag") { // ! we are dragging
    placeholder.setAttribute("id", `placeholder-${Date.now()}`);
    draggable.classList.add("dragging");

  }
  else if (interactionType === "click") { // We are clicking and adding the element from the side menu
