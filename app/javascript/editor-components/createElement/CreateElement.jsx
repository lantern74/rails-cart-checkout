...
function createTextElement(type) {
  ...
  contentElement.classList.add(
    "ne",
    type === "headline-field" ? "elHeadline" : type === "subhead-field" ? "elSubHeadline" : "elText",
    "lh4",
    "elMargin0",
    "elBGStyle0",
    "hsTextShadow0"
  ...
  contentElement.style.textAlign = type === "headline-field" || type === "subhead-field" ? "center" : "";
...
function createListElement() {
  ...
  listWrapperElement.classList.add("ne", "elText", "hsSize3", "lh4", "elMargin0", "elBGStyle0", "hsTextShadow0");
...
function createCountdownElement() {
  ...
  const targetDateStr = `${futureDate.getFullYear()}-${(futureDate.getMonth() + 1).toString().padStart(2, "0")}-${futureDate
    .getDate()
    .toString()
    .padStart(2, "0")}T${futureDate.getHours().toString().padStart(2, "0")}:${futureDate.getMinutes().toString().padStart(2, "0")}:${futureDate
    .getSeconds()
    .toString()
    .padStart(2, "0")}`;
