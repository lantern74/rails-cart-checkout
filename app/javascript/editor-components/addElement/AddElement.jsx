...
function addYellowElementButton() { //yellow 'add an element' in the empty blue div
...
function cloneEditTextControl(element) {
  ...
  document.addEventListener("click", function (event) {
    ...
    if (!element.contains(event.target)) {
      ...
      var editTextRolloverTools = document.querySelector('.text-de-rollover-tools');
...
function elementControl(element) {
  ...
  orangeCloneButton.addEventListener("click", function (e) {
    orangeClone(this);e.stopPropagation();
  });
  ...
  orangeArrowUpButton.addEventListener("click", function (e) {
    moveUp(this.parentElement.parentElement);e.stopPropagation();
  });
  ...
  orangeArrowDownButton.addEventListener("click", function (e) {
    moveDown(this.parentElement.parentElement);e.stopPropagation();
  });
  ...
  orangeAddButton.addEventListener("click", function (e) {
    openAddElementPopup(this);closeAllSidebars();e.stopPropagation();
  });
...
element.childNodes[0].addEventListener("click", function (e) {
  ...
  if (
    ...
    !element.childNodes[0].classList.contains("elText")
      ...
      e.stopPropagation();
       console.log(element.childNodes[2].classList);
