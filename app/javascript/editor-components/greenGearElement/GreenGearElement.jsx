...
function GreenGearElement(id) {
  ...
  // console.log("id: " + selectedGreenSection);
// console.log(`%c green one open?:${setSectionPopup.classList.contains("open") ? 'open' : 'not open'}`, `background: green; color: #fff`);
console.log(`%c I'm in Green Gear Element:${setSectionPopup.classList.contains("open") ? 'open' : 'not open'}`, `background: green; color: #fff`);
...
function loadPresetGreenSettings(id) {
  ...
  backgroundImage.addEventListener("input", function () {
    editorComponent.style.backgroundImage = 'url("' + backgroundImage.value + '")';
  });
