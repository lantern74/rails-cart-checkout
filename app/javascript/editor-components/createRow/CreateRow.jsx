...
function createRowSection() {
  ...
  rowSection.style.cssText = "margin: 10px auto; width: 90%; display: flex; justify-content: center;";
...
function rowControl(rowSection) {
 ...
 // ## add the roll over tools for the blue container
  ...
  //! The plus circle doesn't work here in the popup window
...
function createAndAppendRowSection(event, id, columnCreators) {
  ...
  var columns = columnCreators.map(creator => {
    var divCol = creator();
...
settingRow1.addEventListener("click", function (e) {
  var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol1]);
...
settingRow2.addEventListener("click", function (e) {
    var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol2, createDivCol2]);
...
settingRow3.addEventListener("click", function (e) {
  var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol3, createDivCol3, createDivCol3]);
  // Create and append boundaries for resizing columns
  let boundaries = createAndAppendBoundaries(columns);
  setupResizingBehavior(columns, boundaries);
  setupMouseInteractions(rowSection, columns, boundaries); // Mouse overs
...
settingRow4.addEventListener("click", function (e) {
  var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol4, createDivCol4, createDivCol4, createDivCol4]);
  // Create and append boundaries for resizing columns
  let boundaries = createAndAppendBoundaries(columns);
  setupResizingBehavior(columns, boundaries);
  setupMouseInteractions(rowSection, columns, boundaries); // Mouse overs
...
settingRow5.addEventListener("click", function (e) {
    var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol5, createDivCol5, createDivCol5, createDivCol5, createDivCol5]);
  // Create and append boundaries for resizing columns
  let boundaries = createAndAppendBoundaries(columns);
  setupResizingBehavior(columns, boundaries);
  setupMouseInteractions(rowSection, columns, boundaries); // Mouse overs
...
settingRow6.addEventListener("click", function (e) {
    var { rowSection, columns } = createAndAppendRowSection(e, currentContainerId, [createDivCol6, createDivCol6, createDivCol6, createDivCol6, createDivCol6, createDivCol6]);
  // Create and append boundaries for resizing columns
  let boundaries = createAndAppendBoundaries(columns);
  setupResizingBehavior(columns, boundaries);
  setupMouseInteractions(rowSection, columns, boundaries); // Mouse overs
