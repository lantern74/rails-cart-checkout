...
function loadPresetHeadlineSettings(parentWrapper) {
  ...
  const headlineComponent = document.getElementById(parentWrapper.firstChild.id);
...
export { HeadlineGearElement, selectedHeadlineElement, currentSelectedHeadlineElement };
